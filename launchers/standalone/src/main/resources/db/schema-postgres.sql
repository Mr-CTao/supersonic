...
CREATE TABLE IF NOT EXISTS s2_semantic_gap (
    ...
    diagnostic_stage varchar(64) DEFAULT NULL,
    error_code varchar(64) DEFAULT NULL,
    trace_id varchar(64) DEFAULT NULL,
    error_line integer DEFAULT NULL,
    error_column integer DEFAULT NULL,
    error_token varchar(128) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS s2_semantic_modeling_draft (
    ...
    route_analysis_id bigint DEFAULT NULL,
    route_action varchar(32) DEFAULT NULL,
    route_target_asset_type varchar(32) DEFAULT NULL,
    route_target_asset_id bigint DEFAULT NULL,
    route_target_asset_version bigint DEFAULT NULL,
...
-- AI semantic asset routing snapshots are deliberately isolated from formal semantic metadata.
-- Candidate/evidence payloads contain bounded, schema-validated JSON text and no raw sample rows.
...
CREATE TABLE IF NOT EXISTS s2_semantic_modeling_draft_version (
    ...
    request_fingerprint varchar(128) DEFAULT NULL,
    result_lock_version integer DEFAULT NULL,
    created_by varchar(100) NOT NULL,
    created_at timestamp NOT NULL
);
