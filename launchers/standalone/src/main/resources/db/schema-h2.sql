...
-- AI semantic asset routing: auditable analysis snapshots created before draft generation.
-- Candidate and evidence payloads are bounded, schema-validated JSON text; no sample rows or
-- executable SQL are persisted in this table.
